...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `pincode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
(2, 'nulla nunc', 'Donec quis orci eget orci vehicula condimentum. Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo.', '2022-03-10 07:24:15', 0, 0, 2, 2),
...
(14, 'in lectus pellentesque', 'Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque. Quisque porta volutpat erat.', '2022-04-15 05:32:42', 1, 1, 3, 2),
...
(29, 'duis ac nibh', 'Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis. Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl.', '2022-11-13 05:17:15', 1, 1, 3, 1),
...
(1, 'Course', 'Listes des courses à faire', 0, 0, 1),
(4, 'Divers', 'A faire quand j\'ai le temps ', 0, 0, 1);
COMMIT;
